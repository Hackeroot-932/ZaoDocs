...
<Callout title="Fundamentos de arquitectura" type="info">
...
<Callout title="Evolución de las computadoras" type="info">
...
<div className="p-4 border rounded-lg bg-gray-50 dark:bg-gray-900 my-4">
  <Steps>
    <Step>
      ...
      <Callout title="Cuello de botella de von Neumann" type="warn">
...
<div className="p-4 border rounded-lg bg-gray-50 dark:bg-gray-900 my-4">
  <Steps>
    ...
    <Step>
      ...
      <Callout title="Limitaciones de Harvard" type="warn">
...
<div className="p-4 border rounded-lg bg-gray-50 dark:bg-gray-900 my-4">
  <Steps>
    ...
    <Step>
      ...
      <Callout title="Procesamiento paralelo" type="info">

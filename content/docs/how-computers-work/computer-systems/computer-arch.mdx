...
<Callout title="Architectural Fundamentals" type="info">
...
<Callout title="Computer Evolution" type="info">
...
<div className="p-4 border rounded-lg bg-gray-50 dark:bg-gray-900 my-4">
  <Steps>
    <Step>
      ...
      <Callout title="Von Neumann Bottleneck" type="warn">
...
<div className="p-4 border rounded-lg bg-gray-50 dark:bg-gray-900 my-4">
  <Steps>
    ...
    <Step>
      ...
      <Callout title="Harvard Limitations" type="warn">
